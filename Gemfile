...
group :vmware, :manageiq_default do
  gem 'manageiq-providers-vmware', :git => "https://github.com/skateman/manageiq-providers-vmware", :branch => "satoe-gaprindashvili"
...
group :ui_dependencies do # Added to Bundler.require in config/application.rb
  gem 'manageiq-ui-classic', :git => "https://github.com/skateman/manageiq-ui-classic", :branch => "satoe-gaprindashvili"
  # Modified gems (forked on Github)
